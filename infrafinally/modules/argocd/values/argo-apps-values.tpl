.repo: &repo_link
  ...
  targetRevision: "feature/ayman-infra"
  ref: repo
  ...
  cert-manager:
    ...
    sources:
      - chart: cert-manager
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/cert-manager-values.yaml
      - <<: *repo_link
    metadata:
      annotations:
  ...
  external-secrets-operator:
    ...
    sources:
      - chart: external-secrets
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/eso-values.yaml
      - <<: *repo_link
    metadata:
      annotations:
  ...
  traefik:
    ...
    sources:
      - chart: traefik
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/traefik-values.yaml
  ...
  external-dns:
    ...
    sources:
      - chart: external-dns
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/edns-values.yaml
            # "Surgical" Overrides
          parameters:
  ...
  kube-prometheus-stack:
    ...
    sources:
      - chart: kube-prometheus-stack
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/prometheus-values.yaml
            # "Surgical" Overrides
          parameters:
  ...
  prometheus-mysql-exporter:
    ...
    sources:
      - chart: prometheus-mysql-exporter
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/prometheus-mysql-values.yaml
      - <<: *repo_link
    metadata:
      annotations:
  ...
  prometheus-mongodb-exporter:
    ...
    sources:
      - chart: prometheus-mongodb-exporter
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/prometheus-mongo-values.yaml
      - <<: *repo_link
    metadata:
      annotations:
        argocd.argoproj.io/sync-wave: "-2"
  ...
  defectdojo:
    ...
    sources:
      - chart: defectdojo
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/defectdojo-values.yaml
            # "Surgical" Overrides
          parameters:
            - name: "host"
              value: "dojo.${domain}"
  ...
  opencost:
    ...
    sources:
      - chart: opencost
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/opencost-values.yaml
            # "Surgical" Overrides
          parameters:
            - name: "clusterName"
              value: "${cluster_name}"
  ...
  goldilocks:
    ...
    sources:
      - chart: goldilocks
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/goldilocks-values.yaml
            # "Surgical" Overrides
          parameters:
            - name: "clusterName"
              value: "${cluster_name}"
  ...
  kyverno:
    ...
    sources:
      - chart: kyverno
        ...
        helm:
          valueFiles:
            - $repo/infrafinally/modules/argo/values/kyverno-values.yaml
      - <<: *repo_link
    metadata:
      annotations:
        argocd.argoproj.io/sync-wave: "-2"
